...
FRAMEWORK_LINEAGE_API_NEEDS_UPDATE_TEXT := $(TOPDIR)vendor/deltaotg/build/core/apicheck_msg_current.txt

#BUILD_RRO_SYSTEM_PACKAGE := $(TOPDIR)vendor/lineage/build/core/system_rro.mk
BUILD_RRO_SYSTEM_PACKAGE := $(TOPDIR)vendor/deltaotg/build/core/system_rro.mk

# Rules for MTK targets
#include $(TOPDIR)vendor/lineage/build/core/mtk_target.mk
include $(TOPDIR)vendor/deltaotg/build/core/mtk_target.mk

# Rules for QCOM targets
#include $(TOPDIR)vendor/lineage/build/core/qcom_target.mk
include $(TOPDIR)vendor/deltaotg/build/core/qcom_target.mk
