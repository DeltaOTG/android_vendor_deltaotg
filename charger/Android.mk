...
include $(CLEAR_VARS)
LOCAL_SRC_FILES := healthd_board_deltaotg.cpp
LOCAL_MODULE := libhealthd.deltaotg
LOCAL_CFLAGS := -Werror
LOCAL_C_INCLUDES := \
...
include $$(CLEAR_VARS)
LOCAL_MODULE := vendor_deltaotg_charger_$(notdir $(1))
...
include $(CLEAR_VARS)
LOCAL_MODULE := deltaotg_charger_res_images
LOCAL_MODULE_TAGS := optional
